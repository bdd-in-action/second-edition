...
let FlightsService = class FlightsService {
    ...
    createFlight(flight) {
        ...
        flight = Object.assign(Object.assign({}, flight), { points: this.usersService.updateUserPointsAndLevel(flight.email, earnedPoints), orderNumber: this.generateRandomString(8) });
